...
| `@junando/cdk` | 0.1.0 | — |
| `@junando/core` | 0.18.0 | — |
| `@junando/ingest` | 0.18.0 | — |
| `@junando/webhook` | 0.18.0 | — |
| `@junando/worker` | 0.18.0 | — |
...
|---------------------|---------------|--------------------------------|
| `@anthropic-ai/sdk` | `^0.125.0` | `@junando/core` |
| `@aws-sdk/client-sqs` | `^3.1131.0` | `@junando/ingest`, `@junando/webhook`, `@junando/worker` |
| `@aws-sdk/client-ssm` | `^3.1131.0` | `@junando/worker` |
| `@google/generative-ai` | `^0.24.1` | `@junando/core` |
| `ioredis` | `^6.0.0` | `@junando/core`, `@junando/worker` |
| `prom-client` | `^15.1.3` | `@junando/core` |
| `zod` | `^4.6.4` | `@junando/core`, `@junando/ingest`, `@junando/webhook`, `@junando/worker` |
